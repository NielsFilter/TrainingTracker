...
namespace TrainingTracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController()
            : this(new UserManager<Trainer>(new UserStore<Trainer>(new ApplicationDbContext())))
        {
        }
        ...
        public ActionResult Register()
        {
            ...
            {
                WebSecurity.InitializeDatabaseConnection("DefaultConnection", "Trainer", "EmailAddress", "Name", autoCreateTables: true);
            }
            return View();
        }
        ...
        {
            var trainer = UserManager.FindByIdAsync(User.Identity.GetUserId());
            if (trainer != null)
            {
                return trainer.PasswordHash != null;
            }
            return false;
        }
